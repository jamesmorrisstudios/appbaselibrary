...
# You can edit the include itemSelected and order by changing the proguardFiles
...
-keep class jamesmorrisstudios.com.randremind.data.ReminderListData.** { *; }
-keep class jamesmorrisstudios.com.randremind.data.ReminderItemData.** { *; }
